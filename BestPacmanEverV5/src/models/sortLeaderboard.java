...
public class sortLeaderboard implements Comparator<String> {
    ...
    @Override
    /**
     * This method is used to recursively to look through my array and pick out all of the best scores.
     * This method also takes a string which holds both the user score and name and splits it allowing me to create a leaderboard
     */
